...
namespace dmludp{
    ...
    class SendBuf{
        ...
        void ack_check(){
            std::cout << "ack_count:" << ack_count_important << ", packet_count_important:"<<packet_count_important<< ", bits_set.size:" << bits_set.size() << ", bits_set.count:" << bits_set.count() <<", rcq_important.size:"<< rcq_important.size() <<
            ", meta_status_unimportant:" << static_cast<uint32_t>(meta_status_unimportant) << ", meta_status_important:"<< static_cast<uint32_t>(meta_status_important) << std::endl;
